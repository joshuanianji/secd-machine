(LETREC 
    (COMPILE LAMBDA (E) (COMP E (QUOTE NIL) (QUOTE (4 21))))
    (COMP LAMBDA (E N C) 
        (IF (ATOM E) 
                                                            ...
                                                            (IF (EQ (CAR E) (QUOTE IF)) 
                                                                ...
                                                                (IF (EQ (CAR E) (QUOTE LAMBDA))
                                                                    (LET (CONS (QUOTE 3) (CONS BODY C)) 
                                                                        ...
                                                                        (LET 
                                                                            (LET (COMPLIS ARGS N (CONS (QUOTE 3) (CONS BODY (CONS (QUOTE 4) C))))
                                                                            ...
                                                                            (IF (EQ (CAR E) (QUOTE LETREC)) 
                                                                                (LET 
                                                                                    (LET 
                                                                                        ...
                                                                                        (BODY COMP (CAR (CDR E)) M (QUOTE (5))))
                                                                                    (M CONS (VARS (CDR (CDR E))) N) (ARGS EXPRS (CDR (CDR E)))) 
                                                                                
                                                                                (COMPLIS (CDR E) N (COMP (CAR E) N (CONS (QUOTE 4) C))))))))))))))))))))
    ) 
    
    (COMPLIS LAMBDA (E N C) (IF (EQ E (QUOTE NIL)) (CONS (QUOTE 2) (CONS (QUOTE NIL) C)) (COMPLIS (CDR E) N (COMP (CAR E) N (CONS (QUOTE 13) C))))) 
    (LOCATION LAMBDA (E N) (LETREC (IF (MEMBER E (CAR N)) (CONS (QUOTE 0) (POSN E (CAR N))) (INCAR (LOCATION E (CDR N)))) (MEMBER LAMBDA (E N) (IF (EQ N (QUOTE NIL)) (QUOTE F) (IF (EQ E (CAR N)) (QUOTE T) (MEMBER E (CDR N))))) (POSN LAMBDA (E N) (IF (EQ E (CAR N)) (QUOTE 0) (ADD (QUOTE 1) (POSN E (CDR N))))) (INCAR LAMBDA (L) (CONS (ADD (QUOTE 1) (CAR L)) (CDR L))))) 
    (VARS LAMBDA (D) (IF (EQ D (QUOTE NIL)) (QUOTE NIL) (CONS (CAR (CAR D)) (VARS (CDR D))))) 
    (EXPRS LAMBDA (D) (IF (EQ D (QUOTE NIL)) (QUOTE NIL) (CONS (CDR (CAR D)) (EXPRS (CDR D)))))
)